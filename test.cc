...
public:
  ...
  void chirp(const std::string &key, const std::string &text,
...
TEST(ServiceLayerTestFollowers, statisOK) {
  ...
  // ClientForKeyValueStore client(grpc::CreateChannel("localhost:50000",
...
/*
  ServiceLayerRegisterUser tests if you are able to add users sucessfully to the
  map
*/
